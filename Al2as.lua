-- Auto Teleport to NPCs Menu (Scaled Down 2x with UI Toggle Button)
...
-- Floating Toggle Button to Show/Hide UI
local toggleGuiBtn = Instance.new("TextButton")
toggleGuiBtn.Size = UDim2.new(0, 35, 0, 25)
...
-- Create Main Frame (Scaled down 2x: 120x165)
local mainFrame = Instance.new("Frame")
mainFrame.Size = UDim2.new(0, 120, 0, 165)
mainFrame.Position = UDim2.new(0.5, -60, 0.5, -82.5)
...
-- Toggle UI visibility when clicking the floating button
...
topLabel.Size = UDim2.new(0.9, 0, 0, 12)
topLabel.Position = UDim2.new(0.05, 0, 0, 20)
topLabel.BackgroundTransparency = 1
topLabel.TextColor3 = Color3.fromRGB(200, 200, 200)
topLabel.TextSize = 7
topLabel.Font = Enum.Font.SourceSansBold
topLabel.Text = "Top 3 Max HP:"
topLabel.Parent = mainFrame

-- Container for Top 3 Buttons
local npcButtonsContainer = Instance.new("Frame")
npcButtonsContainer.Size = UDim2.new(0.9, 0, 0, 52)
npcButtonsContainer.Position = UDim2.new(0.05, 0, 0, 34)
...
speedBox.Size = UDim2.new(0.9, 0, 0, 16)
speedBox.Position = UDim2.new(0.05, 0, 0, 90)
speedBox.BackgroundColor3 = Color3.fromRGB(55, 55, 55)
speedBox.TextColor3 = Color3.fromRGB(255, 255, 255)
speedBox.PlaceholderText = "Delay"
speedBox.Text = "0.05"
speedBox.TextSize = 7
...
onButton.Size = UDim2.new(0.43, 0, 0, 20)
onButton.Position = UDim2.new(0.05, 0, 0, 110)
...
offButton.Size = UDim2.new(0.43, 0, 0, 20)
offButton.Position = UDim2.new(0.52, 0, 0, 110)
...
statusLabel.Text = "Target: All (None)"
    ...
    while screenGui.Parent do
        ...
        for i = 1, 3 do
            ...
            if data and data.model and data.model.Parent then
                btn.Text = i .. "." .. data.model.Name .. "(" .. math.floor(data.health) .. ")"
    ...
    btn.MouseButton1Click:Connect(function()
        ...
        if data and data.model and data.model.Parent then
            if selectedNpc == data.model then
                ...
                statusLabel.Text = "Target: All (Deselected)"
            else
            ...
            selectedNpc = nil
            statusLabel.Text = "Target: All (Invalid)"
        end
    end)
end
                ...
                if character and character:FindFirstChild("HumanoidRootPart") then
                    ...
                    if selectedNpc and selectedNpc.Parent then
                        ...
                        if npcRoot and humanoid and humanoid.Health > 0 then
                            ...
                            selectedNpc = nil
                            statusLabel.Text = "Target: All (Died)"
                        end
                    else
